...
\begin{proc}{sudoku\_llenarCelda}{\Inout t: \matriz{\ent}, \In f: \ent, \In c: \ent, \In value: \ent}{}{}
	\pre{(esTableroValido(t) \wedge 0 \leq f,c \leq 8) \yLuego t[f][c] = 0 \yLuego (1 \leq value \leq 9 \wedge t=t_{0})}
	\post{t[f][c] = value \wedge (\forall i: \ent)(\forall j: \ent)((0\leq i,j < |t| \wedge (i \neq f \vee j \neq c)) \implicaLuego t[i][j]= t_{0}[i][j])}
...
\begin{proc}{sudoku\_vaciarCelda}{\Inout t: \matriz{\ent}, \In f: \ent, \In c: \ent}{}{}
	\pre{(esTableroValido(t) \wedge 0 \leq f,c \leq 8) \yLuego t[f][c] \neq 0 \wedge t=t_{0}}
	\post{t[f][c] = 0 \wedge (\forall i: \ent)(\forall j: \ent)((0 \leq i,j < |t| \wedge (i \neq f \vee j \neq c)) \implicaLuego t[i][j] = t_{0}[i][j])}
\end{proc}
...
\begin{proc}{sudoku\_resolver}{\Inout t: \matriz{\ent}, \Out tieneSolucion: \bool}{}{}
	...
	\post{\IfThenElse{(\exists s: \matriz{\ent})(esTableroTotalmenteResuelto(s) \wedge esSubTablero(s,t))\\}{tieneSolucion=\True \wedge t=s\\}{tieneSolucion = \False}}
\end{proc}
