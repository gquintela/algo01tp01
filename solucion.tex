...
\hfill
	...
	esTableroValido(t) \yLuego (\forall i: \ent)(0 \leq i \textless |t| \implicaLuego (noHayRepetidosEnFila(t[i]) \yLuego noHayRepetidosEnColumna(t) \yLuego noHayRepetidosEnRegion(t))}	
