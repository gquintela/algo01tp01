...
\hfill	
	...
	(0\leq i,j,k,l < 9 \wedge (i \text{ div } 3 = k \text{ div } 3) \wedge (j \text{ div } 3 = l \text{ div } 3) \wedge (i \neq k \vee j \neq l) \implicaLuego (t[i][j] = 0 \oLuego t[k][l] = 0 \oLuego t[i][j] \neq t[k][l]))\\}
	
\hfill

	\pred{noHayRepetidosEnFila}{s: \TLista{\ent}}{
	(\forall i: \ent)(\forall j: \ent)(0 \leq i,j < |s| \wedge j \neq i \implicaLuego (s[i] = 0 \oLuego s[j] = 0 \oLuego s[i] \neq s[j]))\\}
	
\hfill

	\pred{noHayRepetidosEnColumna}{t: \matriz{\ent}}{
	(\forall j: \ent)(0 \leq j < |t| \implicaLuego (\forall l: \ent)(\forall k: \ent)\\
	(0 \leq l,k < |t| \wedge l \neq k  \implicaLuego (t[l][j] = 0 \oLuego t[k][j] = 0 \oLuego t[l][j] \neq t[k][j])))\\}
