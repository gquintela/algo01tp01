...
\begin{proc}{sudoku\_primeraCeldaVaciaColumna}{\In t: \matriz{\ent}, \Out result: \ent}{}{}
	\pre{esTableroValido(t)}
	\post{(\exists i: \ent)(esPrimeraFilaConCeldaVacia(t, i) \wedge \\ esPrimeraCeldaVaciaEnFila(t[i], result)) \vee \\(\neg(\exists i: \ent)(0 \leq i < 
|t| \yLuego filaTieneCeldaVacia(t[i])) \wedge result = -1)}
	\pred{esPrimeraCeldaVaciaEnFila}{s: \TLista{\ent}, k: \ent}{0 \leq k < |t| \yLuego s[k] = 0 \wedge (\forall i: \ent)(0 \leq i < k \implicaLuego s[i] \neq 0)}
\end{proc}
