...
\begin{proc}{sudoku\_tieneSolucion}{\In t: \matriz{\ent}, \Out tieneSolucion: \bool}{}{}
	\pre{esTableroValido(t)}
	\post{(\exists s: \matriz{\ent})(esTotalmenteResuelto(s) \yLuego esSubTablero(s,t))}
\end{proc}

\begin{proc}{sudoku\_resolver}{\Inout t: \matriz{\ent}, \Out tieneSolucion: \bool}{}{}
	\pre{esTableroValido(t) \yLuego t=t_{0}}
	\post{\IfThenElse{(\exists s: \matriz{\ent})(esTotalmenteResuelto(s) \yLuego esSubTablero(s,t))\\}{tieneSolucion=true \wedge t=s\\}{tieneSolucion = false}}
\end{proc}

\begin{proc}{sudoku\_copiarTablero}{\In src: \matriz{\ent}, \Out target: \matriz{\ent}}{}{}
	\pre{esTableroValido(src)}
	\post{(\forall i: \ent)(\forall j: \ent)(0 \leq i,j < |src| \implicaLuego (target[i][j] = src[i][j] \yLuego esTableroValido(target))}
\end{proc}
...
\hfill	
	...
	(0\leq i,j,k,l < 9 \yLuego (i div 3 = k div 3) \yLuego (j div 3 = l div 3) \yLuego (i \neq k \vee j \neq l) \implicaLuego (t[i][j] = 0 \vee t[k][l] = 0 \vee t[i][j] \neq t[k][l]))\\}
...
\hfill
	...
	(0 \leq l,k < |t| \yLuego l \neq k  \implicaLuego (t[i][j] = 0 \vee t[k][l] = 0 \vee t[i][j] \neq t[k][j])))\\}
