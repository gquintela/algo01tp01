...
\begin{proc}{sudoku\_primeraCeldaVaciaFila}{\In t: \matriz{\ent}, \Out result: \ent}{}{}
    \pre{esTableroValido(t)}
    \post{\IfThenElse{(\exists i: \ent)(0 \leq i \textless |t| \yLuego filaTieneCeldaVacia(t[i]) \yLuego (\forall j: \ent)
\\    
    (0 \leq j \textless i \implicaLuego \neg filaTieneCeldaVacia(t[j])))\\}{result = i\\}{result = -1}}
...
\begin{proc}{sudoku\_esTableroTotalmenteResuelto}{\In t: \matriz{\ent}, \Out result: \bool}{}{}
    \pre{true}
    \post{esParcialmenteResuelto(t)  $\yLuego$ \forall i: \ent) (0 \leq i < |t| $\implicaLuego$ \neg filaTieneCeldaVacia(t[i]) }
    \end{proc}
    
    \hfill

\begin{proc}{sudoku\_esTablero}{\In t_{0},t_{1}: \matriz{\ent}, \Out result: \bool}{}{}
    \pre{true}
    \post{esSubtablero(t_{0},t_{1})=result}
    \end{proc}
...
\hfill	
	...
	(0\leq i,j,k,l \textless 9 \yLuego (i div 3 = k div 3) \yLuego (j div 3 = l div 3) \yLuego (i \neq k \vee j \neq l) \implicaLuego t[i][j] \neq t[k][l]}
...
\hfill
	...
	(\forall j: \ent)(0 \leq j \textless |t| \implicaLuego (\forall l: \ent)(\forall k: \ent)\\
	(0 \leq l,k \textless |t| \yLuego l \neq k  \implicaLuego t[i][j] \neq t[k][j]))}
	
\hfill

	\pred{esTableroParcialmenteResuelto}{t: \Tlista{\ent}}{
	esTableroValido(t) \yLuego (\forall i: \ent)(0 \leq i \textless |t| \implicaLuego \\
	  (noHayRepetidosEnFila(t[i]) \yLuego noHayRepetidosEnColumna(t) \yLuego noHayRepetidosEnReligion(t))}	
